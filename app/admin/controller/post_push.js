...
var _class = function (_Post) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = _class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call.apply(_ref, [this].concat(args))), _this), _this.postModelInstance = _this.model('post'), _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(_class, [{
    ...
    key: 'updatePost',
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(post) {
        var rows;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                if (post.markdown_content) {
                  post = this.postModelInstance.getContentAndSummary(post);
                }
                if (post.create_time) {
              ...
              case 6:
                _context3.next = 8;
                return this.postModelInstance.savePost(post);
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                _context5.next = 5;
                return this.postModelInstance.where({ pathname: post.pathname }).find();
              ...
              case 11:
                ...
                _context5.next = 14;
                return this.postModelInstance.getContentAndSummary(post);
              ...
              case 18:
                ...
                _context5.next = 22;
                return this.postModelInstance.addPost(post);
