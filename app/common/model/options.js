...
var _class = function (_think$model$base) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = _class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call.apply(_ref, [this].concat(args))), _this), _this.cacheKey = 'website_options', _this.cacheOptions = {
  ...
  (0, _createClass3.default)(_class, [{
     ...
     */
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(flag) {
        var _this2 = this;
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(key, value) {
        var data, cacheData, changedData, _key2, p1, promises, _key3, _value, exist, p, postModel;

        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                data = think.isObject(key) ? think.extend({}, key) : (0, _defineProperty3.default)({}, key, value);
                _context3.next = 3;
              ...
              case 30:
                ...
                postModel = think.model('post', {}, 'admin');
                // doesn't wait for return

                _context3.next = 34;
                return postModel.updateAllPostSummaries();
