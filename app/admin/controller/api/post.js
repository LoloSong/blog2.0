...
var _class = function (_Base) {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    key: 'getBaseAction',
    value: function getBaseAction(self) {
      return (0, _get3.default)(_class.prototype.__proto__ || (0, _getPrototypeOf2.default)(_class.prototype), 'getAction', this).call(this, self);
    }
    /**
     * add user
     * @return {[type]} [description]
    ...
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {
        var data, post, _post, options, rows;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                ...
                return _context3.abrupt('return', this.fail('USER_NO_PERMISSION'));
              ...
              case 26:
                ...
                options = JSON.parse(_post.options || '{}');
