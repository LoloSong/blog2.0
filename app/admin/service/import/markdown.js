...
var _class = function (_Base) {
  ...
  function _class(think) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, think));
  ...
  (0, _createClass3.default)(_class, [{
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 3:
                            ...
                            _context4.next = 7;
                            return think.model('post', null, 'admin').getContentAndSummary(_post);
    ...
    value: function parseFile(file) {
      try {
        var filePath = file.path.replace(/[^a-zA-Z0-9.\/_-]/g, '');
        (0, _child_process.execSync)('rm -rf ' + PATH + '; mkdir ' + PATH + '; cd ' + PATH + '; tar zxvf "' + filePath + '"');
