...
var _class = function (_think$service$base) {
  ...
  (0, _createClass3.default)(_class, [{
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                if (!(comment.type === 'hypercomments')) {
                  _context.next = 15;
                  break;
                }

                return _context.abrupt('return', this.syncFromHyperComments(comment));
              ...
              case 27:
                if (!(comment.type === 'gitalk')) {
                  _context.next = 29;
                  break;
                }

                return _context.abrupt('return', this.syncFromGitalk(comment));
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 21:
                ...
                promises = data.map(function (item) {
                  ...
                  return _this2.model('post').where({
                    id: id
                  }).update({
    ...
    key: 'syncFromHyperComments',
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(comment) {
        var postData, url, site_url, i, post, threads, index, ths, formData, resp, data, promises, _i, _post, id;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                url = 'https://c1n1.hypercomments.com/api/get_count';
              ...
              case 16:
                formData = {
                  data: (0, _stringify2.default)({
                    ...
                    href: ths.map(function (th) {
                      return postData[th].url;
                    })
                  }),
                  host: site_url
                };
              ...
              case 25:
                ...
                if (!(data[_i].cm === _post.comment_num)) {
                  _context4.next = 29;
                  break;
                }
      ...
      function syncFromHyperComments(_x2) {
        return _ref4.apply(this, arguments);
      }

      return syncFromHyperComments;
    }()
    /**
     * sync from duoshuo
     * @return {[type]} [description]
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 15:
                ...
                promises = [];
                _context6.t0 = _regenerator2.default.keys(data);
    ...
    key: 'syncFromNetease',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(comment) {
        var postData, site_url, i, post, threads, index, url, ths, formData, resp, data, promises, _i2, _post2, id;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 23:
                ...
                _post2 = postData[ths[_i2]];

                if (!(data[_i2] === _post2.comment_num)) {
                  _context7.next = 27;
                  break;
                }
    ...
    key: 'syncFromGitalk',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(comment) {
        var postData, gtalkConfig, base64Header, url, options, promises, i, post, response, commentNum, id;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                gtalkConfig = JSON.parse(comment.name);
                base64Header = new Buffer(gtalkConfig.githubUserName + ':' + gtalkConfig.githubPassWord).toString('base64');
                url = 'https://api.github.com/search/issues?q=author:' + gtalkConfig.owner;
                options = {
                  url: url,
                  headers: {
                    'User-Agent': 'request',
                ...
                promises = [];
                _context8.t0 = _regenerator2.default.keys(postData);
      ...
      function syncFromGitalk(_x6) {
        return _ref8.apply(this, arguments);
      }

      return syncFromGitalk;
    }()
  }, {
    key: 'clearPostCache',
    value: function clearPostCache() {
