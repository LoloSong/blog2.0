...
var _class = function (_Post) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = _class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call.apply(_ref, [this].concat(args))), _this), _this.tableName = 'post', _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
