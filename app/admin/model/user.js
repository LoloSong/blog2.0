...
var _class = function (_Base) {
  ...
  (0, _createClass3.default)(_class, [{
     ...
     * @return {String}          []
     */
    value: function getEncryptPassword(password) {
    ...
    key: 'checkPassword',
    value: function checkPassword(userInfo, password) {
      var passwordHash = new _phpass.PasswordHash();
      return passwordHash.checkPassword(password, userInfo.password);
    }
  }, {
    key: 'generateKey',
    value: function generateKey(userId, app_key, app_secret, status) {
    ...
    key: 'afterSelect',
    value: function afterSelect(data) {
      var _this2 = this;
    ...
    key: 'addUser',
    value: function addUser(data, ip) {
